...
namespace ACT4
{
    public partial class Form1 : Form
    {
        ...
        double temperature = 100.0; // Initial temp
        double coolingRate = 0.9999999999; // Cooling factor
        ...
        private void executeMove(Point move)
        {
            ...
            // Calculate the change in attacking pairs
            int delta = newAttackingPairs - currentAttackingPairs;

            // Check if the new state is better, or accept worse state based on temperature
            if (delta < 0 || (Math.Exp(-delta / temperature) > new Random().NextDouble()))
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (bMoves.Count > 0)
                executeMove((Point)chooseMove(bMoves));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // loops until the temperature is close to 0
            while (temperature > 0) 
            {
